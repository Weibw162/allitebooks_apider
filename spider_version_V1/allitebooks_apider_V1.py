...
class Taobao_spider(object):
    ...
    def get_book_type_response(self):
        ...
        print("正在获取网页信息")
        book_type_response = requests.get(self.url,headers=self.get_headers(),proxies=self.proxies,timeout=2).content.decode("utf-8")
        print("网页信息获取成功")
    ...
    def save_data(self,data):
        ...
        print("开始保存数据")
        json.dump(data,open('book_info2.json','w'))
        print("数据保存完毕")
